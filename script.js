...
function tombol() { wallpaper.style = "transform: scale(1);"; Tombol.style = "opacity:1;transform: scale(1);"; if (fungsi == 2) { By.innerHTML = "&#128140; Reply Here" } }
...
else if (waktuSekarang < 16) { ucapan = "Good afternoon, "; }
else if (waktuSekarang < 19) { ucapan = "Good afternoon, "; }
